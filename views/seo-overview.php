...
<!-- Mirrored from mdbootstrap.com/live/_MDB/templates/Admin/seo-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2017 14:58:47 GMT -->
<head>
    ...
    <!-- Meta OG -->
    <meta property="og:title" content="Responsive Admin Dashboard SEO Template">
    <meta property="og:description" content="Keep track of your SEO with proper data catgorization and intuitive layout - part of this responsive material admin template.">
    <meta property="og:image" content="../../../../img/Live/MDB/Admin/seo.jpg">
    <meta property="og:url" content="seo-overview.html">
    <meta property="og:site_name" content="mdbootstrap.com">
    <!-- /Meta OG -->

    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:description" content="Keep track of your SEO with proper data categorization and intuitive layout - part of this responsive material admin template." />
    <meta name="twitter:title" content="Responsive Admin Dashboard SEO Template" />
    <meta name="twitter:site" content="@MDBootstrap" />
    <meta name="twitter:image" content="../../../../img/Live/MDB/Admin/seo.jpg" />
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-6 panel-title">
                        <h4><span class="purple">Search analitycs</span></h4>
                    </div>
                    <!--/First column-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-cascade narrower">
                                ...
                                <!--Admin panel-->
                                <div class="admin-panel purple-admin-panel">
                                        ...
                                        <div class="col mt-1 mb-2">
                                            ...
                                            <div class="btn-group mt-1" data-toggle="buttons">
                                                <label class="btn btn-md btn-secondary active">
                                                    <input type="checkbox" name="options" id="option1" autocomplete="off" checked>Clicks <strong>1000</strong> <i class="fa fa-arrow-up ml-2 green-text"></i> <strong>25%</strong>
                                                </label>
                                            </div>
                                            <div class="btn-group mt-1" data-toggle="buttons">
                                                <label class="btn btn-md">
                                                    <input type="checkbox" name="options" id="option2" autocomplete="off">Impressions <strong>1000</strong> <i class="fa fa-arrow-up ml-2 green-text"></i> <strong>25%</strong>
                                                </label>
                                            </div>
                                            <div class="btn-group mt-1" data-toggle="buttons">
                                                <label class="btn btn-md">
                                                    <input type="checkbox" name="options" id="option2" autocomplete="off">CTR <strong>5%</strong> <i class="fa fa-arrow-up ml-2 green-text"></i> <strong>25%</strong>
                                                </label>
                                            </div>
                                            <div class="btn-group mt-1" data-toggle="buttons">
                                                <label class="btn btn-md">
                                                    <input type="checkbox" name="options" id="option2" autocomplete="off">Position <strong>4.14</strong> <i class="fa fa-arrow-up ml-2 green-text"></i> <strong>25%</strong>
                                                </label>
                                            </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="md-form input-group mt-1">
                                                <form class="form-inline waves-effect waves-light">
                                                    ...
                                                    <button class="btn btn-sm ml-2"><i class="fa fa-search"></i>  </button>
                                                </form>
                                            </div>
                                            ...
                                            <div class="card-block pt-0">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr class="none-top-border">
                                                                ...
                                                                <td>5%</td>
                                                                <td>3.21</td>
                                                                <td>2 <span class="badge green">1 <i class="fa fa-arrow-circle-up"></i></span></td>
                                                                <td>2 <span class="badge red">1 <i class="fa fa-arrow-circle-down"></i></span></td>
                                                    ...
                                                    <div class="d-inline-flex float-right">
                                                        ...
                                                        <strong class="mr-2">Show rows:</strong>
                                                        ...
                                                        <strong class="mx-2">1-10 of 18</strong>
                                                        <a class="btn btn-sm mx-1 my-0"><i class="fa fa-chevron-left"></i></a>
                                                        <a class="btn btn-sm mx-1 my-0"><i class="fa fa-chevron-right"></i></a>
                                                    </div>
                                                    <!--/Table UI-->
                                                </div>
                                                <!--/Table-->
...
<!-- Mirrored from mdbootstrap.com/live/_MDB/templates/Admin/seo-overview.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Apr 2017 14:58:48 GMT -->
</html>